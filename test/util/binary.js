...
test('binarySearchWithRangeDouble: Range not exceed index bound', t => {
...
test('binarySearchWithRangeDouble: Range exceed left-handed bound', t => {
  const indexes = [51, 52, 53, 54];
...
test('binarySearchWithRangeDouble: Range exceed right-handed bound', t => {
  const indexes = [51, 52, 53, 54];
  const point = 52.0789;
  const range = 0.16;
...
test('binarySearchWithRangeDouble: Range exceed right-handed and left-handed bound', t => {
  const indexes = [51, 52, 53, 54];
  const point = 52.5;
  const range = 1;
...
// -1.50 # 52.5 # +1.50
// 51.0 # 52.5 # 54.0
test('binarySearchWithRangeDouble: Range exceed left-handed and right-handed with 1.5 and fill 4 gap', t => {
